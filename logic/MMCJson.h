...
/// make sure the value is converted into an array of strings. throw otherwise.
QStringList ensureStringList(const QJsonValue val, QString what = "value");

void writeFile(const QString &filename, const QJsonDocument &obj, const bool binary = true);
