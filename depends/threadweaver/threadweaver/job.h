...
public:
     ...
     */
    virtual void execute(JobPointer job, Thread *) override;
...
protected:
    ...
    void freeQueuePolicyResources(JobPointer) override;
     ...
     * job is the Job that the queue is executing. It is not necessarily equal to this. For example, Jobs that are
     * decorated expose the decorator's address, not the address of the decorated object. */
    void defaultBegin(JobPointer job, Thread *thread) override;
     ...
     * job is the Job that the queue is executing. It is not necessarily equal to this. For example, Jobs that are
     * decorated expose the decorator's address, not the address of the decorated object. */
    void defaultEnd(JobPointer job, Thread *thread) override;
